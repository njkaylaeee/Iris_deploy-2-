...
# prompt: create code for save model

import joblib
import os

# Example: Train a simple model (e.g., Decision Tree)
...
save_path = '/content/drive/MyDrive/Iris_Dataset/models'
if not os.path.exists(save_path):
    os.makedirs(save_path)

# Define the model filename
model_filename = os.path.join(save_path, 'decision_tree_model.pkl')
